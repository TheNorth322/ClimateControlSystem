...
namespace ClimateControlSystem.ui.ViewModel.ClimateControlSystem
{
    public class RoomDetailsViewModel : ViewModelBase
    {
        ...
        public string LightLevel => (SelectedRoom != null ) ? EnumExtensionMethods.GetEnumDescription(SelectedRoom.LightLevel) : "Unknown";
        ...
        public string ConditionerMode => (SelectedRoom != null ) ? EnumExtensionMethods.GetEnumDescription(SelectedRoom.Conditioner.ConditionerMode) : "Unknown";
        ...
        public string ExpectedCarbonDioxide => SelectedRoom?.Purificator.ExpectedCarbonDioxideLevel.ToString() ?? "Unknown";
